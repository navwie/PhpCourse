            ...
            <form enctype="multipart/form-data" action="/createJewelry" method="post">
                ...
                <div class="form-group el">
                    <div class="el">
                        ...
                        <input id="amount" style="width: 400px" type="text" placeholder="Введите количество"
                               name="amount">
                    </div>
                </div>
                ...
                <div class="radio">
                        ...
                        <div class="product">
                            ...
                            <div class="radioChoice1">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" id="type_id1"
                                           name="type_id">
                                    <label class="custom-control-label" for="type_id1">Серьги</label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="2" id="type_id2"
                                           name="type_id">
                                    <label class="custom-control-label" for="type_id2">Кольца</label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="3" id="type_id3"
                                           name="type_id">
                    ...
                    <div class="form-group">
                        <div class="product">
                            ...
                            <div class="radioChoice2">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" id="material_id1"
                                           name="material_id">
                                    <label class="custom-control-label" for="material_id1"> Серебро </label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="2" id="material_id2"
                                           name="material_id">
                    ...
                    <div class="form-group">
                        <div class="product">
                            ...
                            <div class="radioChoice2">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" id="sex_id1"
                                           name="sex_id">
                                    <label class="custom-control-label" for="sex_id1"> Мужской </label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="2" id="sex_id2"
                                           name="sex_id">
                                    <label class="custom-control-label" for="sex_id2"> Женский</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="product">
                        ...
                        <textarea style="width: 450px;height: 100px" type="text" id="form1" class="form-control"
