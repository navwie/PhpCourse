            ...
            <form action="updateJewelry" method="post">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="number" id="amount" name="amount"
                           value="<?php echo $params['jewelry'][0]->getAmount() ?>">
                </div>
                <div class="form-group mt-4">
                    <label for="description">Описание</label>
                    <textarea type="text" id="description" name="description"
                              style="width: 300px;height: 150px"><?php echo $params['jewelry'][0]->getDescription() ?></textarea>
                </div>
                <div class="form-group mt-4">
                    <label for="price">Цена</label>
                    <input type="number" id="price" name="price"
                           value="<?php echo $params['jewelry'][0]->getPrice() ?>">
                </div>
                <div class="form-group mt-4">
                ...
                <div class="form-group text-center">
                    <button type="submit" class="btn btn-outline-dark"
                            value="<?php echo $params['jewelry'][0]->getId() ?>" name="id">Изменить
                    </button>
                </div>
            </form>
        </div>
