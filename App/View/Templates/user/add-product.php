            ...
            <form action="/addBook" method="post">
                ...
                <div class="form-group el">
                    <div class="el">
                        ...
                        <input id="name" type="text" placeholder="Введите название" name="title" >
                    </div>
                </div>
                ...
                <div class="form-group el">
                  <div class="el">
                        ...
                        <input  id="price" type="text" placeholder="Введите цену" name="price">
                    </div>
                </div>
                ...
                <div class="form-group el">
                    <div class="el">
                        ...
                        <input  id="amount" type="text" placeholder="Введите количество" name="amount">
                    </div>
                </div>
                    ...
                    <div class="product">
                        ...
                        <div class="radioChoice1">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" value="Серьги" id="type_id1"  name="type_id">
                                <label class="custom-control-label" for="type_id1">Серьги</label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" value="Кольца" id="type_id2"  name="type_id">
                                <label class="custom-control-label" for="type_id2">Кольца</label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" value="Браслет" id="type_id3" name="type_id">
                ...
                <div class="form-group">
                    <div class="product">
                        ...
                        <div class="radioChoice2">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" value="Серебро" id="material_id1"   name="material_id">
                                <label class="custom-control-label" for="material_id1"> Серебро </label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input"  value="Золото" id="material_id2"  name="material_id">
                ...
                <div class="form-group">
                    <div class="product">
                        ...
                        <textarea type="text" id="form1" class="form-control" name="description"></textarea>
                    </div>
                </div>
